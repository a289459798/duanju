...
let IconPhotoFailCopy: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconPhotoFailCopy.defaultProps = {
  size: 18,
};

IconPhotoFailCopy = React.memo ? React.memo(IconPhotoFailCopy) : IconPhotoFailCopy;

export default IconPhotoFailCopy;
